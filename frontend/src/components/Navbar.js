...
function Navbar() {
  ...
  return (
    <nav className={`pt-10 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white h-full fixed p-2 border-r border-gray-400 dark:border-gray-1000 transition-all duration-300 ${isCollapsed ? 'w-45' : 'w-64'}`}>
